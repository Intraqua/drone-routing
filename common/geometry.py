...
Implementa los algoritmos geométricos del Tema 7 del curso.
...
def cross_product(o: Point, a: Point, b: Point) -> float:
    ...
    Basado en el Tema 7: Algoritmos geométricos - Fundamentos.
    """
...
def on_segment(p: Point, q: Point, r: Point) -> bool:
    ...
    Tema 7: Entrenamiento 1 - Cálculo del punto sobre un segmento.
    """
...
def segments_intersect(p1: Point, q1: Point, p2: Point, q2: Point) -> bool:
    ...
    Implementa el algoritmo del Tema 7: Entrenamiento 2 - Intersección
    de segmentos en 2D:
...
def point_in_polygon(point: Point, polygon: Polygon) -> bool:
    ...
    Tema 7: Entrenamiento 4 - Inclusión de punto en un polígono.
...
def segment_passes_through_polygon(p1: Point, p2: Point, polygon: Polygon) -> bool:
    ...
    Combina los tests del Tema 7 para verificación completa:
    1. Intersecta algún lado del polígono (Entrenamiento 2), O
    2. Algún extremo está dentro del polígono (Entrenamiento 4), O
...
def polygon_area(polygon: Polygon) -> float:
    """
    Calcula el área de un polígono usando la fórmula del área signada
    (Shoelace formula).

    Tema 7: Entrenamiento 5 - Área de un polígono.
    """
    n = len(polygon)
    area = 0.0
    for i in range(n):
...
if __name__ == "__main__":
    print("=" * 60)
    print("PRUEBAS DEL MÓDULO DE GEOMETRÍA - TEMA 7")
    print("=" * 60)

    # Test de intersección de segmentos (Entrenamiento 2)
    print("\n1. Test de intersección de segmentos (Tema 7, Ent. 2):")

    # Segmentos que se cruzan - Ejemplo del entrenamiento
    p1, q1 = (0, 0), (4, 4)
    p2, q2 = (0, 4), (4, 0)
    ...
    # Test de punto en polígono (Entrenamiento 4)
    print("\n2. Test de punto en polígono (Tema 7, Ent. 4):")
    ...
    # Test de segmento atravesando polígono (zona no-fly)
